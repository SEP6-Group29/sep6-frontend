...
export const MOVIES_BY_DECADE80 ="https://movieapp-sep6.azurewebsites.net/api/movienames/top/8"; //80s
export const MOVIES_BY_DECADE90 ="https://movieapp-sep6.azurewebsites.net/api/movienames/top/9"; //90s
export const MOVIES_BY_DECADE00 ="https://movieapp-sep6.azurewebsites.net/api/movienames/top/0"; //00s
export const MOVIES_BY_DECADE10 ="https://movieapp-sep6.azurewebsites.net/api/movienames/top/10"; //10s
